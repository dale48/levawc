...
void add_nodes(BiTree tree, int nr_of_nodes);
void remove_nodes(BiTree tree);
void insert_nodes(BiTree tree);
...
/* --- Function: void add_nodes(BiTree tree, int nr_of_nodes) --- */
void add_nodes(BiTree tree, int nr_of_nodes)
{
  ...
  printf("\n%d/%d successful insertions -- %d duplicates rejected...", BITREEsize(tree), nr_of_nodes, dupctr);
}
...
int main(void)
{
  ...
  insert_nodes(mytree);
  my_clearscrn();  
  BITREEprint(mytree, print);
  printf("INORDER: ");
  BITREEinorder(mytree, print);
